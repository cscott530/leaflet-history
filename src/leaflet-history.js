...
(function (window, document) {
    ...
    L.HistoryControl = L.Control.extend({
        ...
        util: {
            buildZoomCenterObjectFromCurrent:function(map) {
                return new L.ZoomCenter(map.getZoom(), map.getCenter());
            },
            removeFirstIfTooBig: function(stack, maxSize) {
        ...
        _addMapListeners: function() {
            ...
            this.map.on('moveend', function(e) {
                if(!_this.state.ignoringEvents) {
                    _this.state.future = [];
                    _this.state.history.push(_this.util.buildZoomCenterObjectFromCurrent(e.target));
                    _this.util.removeFirstIfTooBig(_this.state.history, _this.options.maxHistorySize);
                }
